...
export type { Renderer, RendererConfig, ScalarRenderOptions, VectorRenderOptions, TrajectoryRenderOptions, ParticleRenderOptions, TraceCallback, DragCallback } from './renderer'
